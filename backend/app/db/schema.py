...
-- Model Configs Table (for storing model configurations)
CREATE TABLE IF NOT EXISTS model_configs (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    provider TEXT NOT NULL,
    model_name TEXT NOT NULL,
    api_key_encrypted TEXT,  -- Store encrypted or reference to env
...
-- Analytics Table (for tracking newsletter performance)
...
def init_database():
    ...
    Note: This should be run manually in Supabase SQL editor for security.
    This function can be used to verify schema exists.
    """
    try:
        ...
        print("2. Copy the SQL from backend/supabase/migrations/001_init_schema.sql")
